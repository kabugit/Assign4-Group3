...
Figure \@ref(fig:numcount) shows that games are the category with the highest number of rating, much higher than all other categories
...
It can be seen from Table \@ref(tab:ranknumcount) that the number of people who rated games is far more than the number of people who rated other genres. The top three are games, social networking and photo & video.
